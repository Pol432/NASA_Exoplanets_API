...
class ExoplanetCandidate(Base):
    ...
    # Analysis status
    analysis_status = Column(Enum(AnalysisStatus),
    ...
    # Flag columns for ML model
    koi_fpflag_ss = Column(Integer, nullable=True)  # Stellar Eclipse Flag
    koi_fpflag_co = Column(Integer, nullable=True)  # Centroid Offset Flag
    koi_fpflag_nt = Column(Integer, nullable=True)  # Not Transit-Like Flag
    # Ephemeris Match Indicates Contamination Flag
    koi_fpflag_ec = Column(Integer, nullable=True)

    # Additional analysis fields
    analysis_notes = Column(Text, nullable=True)
    # JSON string of quality indicators
    ...
    analysis_sessions = relationship(
        "AnalysisSession", back_populates="candidate", cascade="all, delete-orphan")
    feedback_entries = relationship(
        "ResearcherFeedback", back_populates="candidate", cascade="all, delete-orphan")
